# Reference Star Dice Visual Match Specification

## Purpose
Defines the visual acceptance workflow and reference-image matching requirements for star table dice reproduction work, including screenshot evidence, engineering versus human visual acceptance, solid dice readability, table grounding, lighting, and unresolved-gap reporting.
