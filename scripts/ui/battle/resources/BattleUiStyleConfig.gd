...
@export var formula_chips_badge_texture: Texture2D = null
@export var formula_mult_badge_texture: Texture2D = null
@export var formula_xmult_badge_texture: Texture2D = null
...
@export var floating_chips_text_color: Color = Color(0.96, 0.95, 0.88)
@export var floating_mult_text_color: Color = Color(1.0, 0.78, 0.16)
...
@export var card_gap: int = 8
@export var left_sidebar_width: int = 456
@export var left_target_score_panel_height: int = 250
@export var left_current_score_panel_height: int = 74
@export var left_core_combo_panel_height: int = 188
@export var left_score_formula_panel_height: int = 86
...
@export var formula_badge_size: Vector2 = Vector2(112, 62)
@export var formula_chips_badge_size: Vector2 = Vector2(112, 62)
@export var formula_mult_badge_size: Vector2 = Vector2(112, 62)
@export var formula_badge_gap: int = 4
@export var formula_separator_width: int = 24
@export var formula_badge_font_size: int = 46
@export var formula_separator_font_size: int = 30
@export var floating_score_font_size: int = 34
@export var floating_score_size: Vector2 = Vector2(220, 54)
@export var floating_score_duration_seconds: float = 1.0
@export var floating_score_slide_pixels: float = 28.0
@export var floating_score_shake_pixels: float = 7.0
@export var floating_score_above_dice_gap: float = 8.0
